...
public enum CharStreams {
	...
	public static CodePointCharStream fromChannel(
		...
		throws IOException
	{
		CodePointBuffer codePointBuffer = bufferFromChannel(channel, charset, bufferSize, decodingErrorAction, inputSize);
		return CodePointCharStream.fromBuffer(codePointBuffer, sourceName);
	}

	public static CodePointBuffer bufferFromChannel(
		ReadableByteChannel channel,
		Charset charset,
		int bufferSize,
		CodingErrorAction decodingErrorAction,
